...
#ifndef DIABLO_UTILS__DIABLO_TOOLS__ONBOARD_SDK_UART_PROTOCOL_H_
#define DIABLO_UTILS__DIABLO_TOOLS__ONBOARD_SDK_UART_PROTOCOL_H_
...
typedef struct
{
  ...
  uint8_t SESSION : 5;   // session ID, 0: Sender doesn't need ACKs.
  // 1:Sender needs ACKs but can be tolerated. 2:Sender needs ACKs.*
...
typedef struct
{
  ...
  uint8_t timeout_act : 1;  // Action after drop connection,
  // 1:Automatically switches to real remote control
...
#endif  // DIABLO_UTILS__DIABLO_TOOLS__ONBOARD_SDK_UART_PROTOCOL_H_
