...
MissionPanel::MissionPanel(QWidget* parent):rviz_common::Panel(parent)
{
  ...
  mission_pub_ = dummy_node_->create_publisher<motion_msgs::msg::MotionCtrl>("diablo/MotionCmd", rclcpp::SystemDefaultsQoS());
  icon_off_path_ = QString::fromStdString(ament_index_cpp::get_package_share_directory("diablo_rviz2_control_plugin") + "/data/ddt_off_64.png");
  icon_on_path_ = QString::fromStdString(ament_index_cpp::get_package_share_directory("diablo_rviz2_control_plugin") + "/data/ddt_on_64.png");
